...
%type <classes> class_list_semicolon
%type <class_> class

/* You will want to change the following line. */
%type <features> feature_list_semicolon
%type <feature> feature

%type <formals> formal_list_comma
%type <formal> formal

%type <expressions> expression_list_comma expression_list_semicolon
...
|   CLASS TYPEID '{' feature_list_semicolon '}'
                        { $$ = class_($2,idtable.add_string("Object"),$4, stringtable.add_string(curr_filename)); }
|   CLASS TYPEID INHERITS TYPEID '{' '}'
                        { $$ = class_($2,$4,nil_Features(),stringtable.add_string(curr_filename)); }
|   CLASS TYPEID INHERITS TYPEID '{' feature_list_semicolon '}'
                        { $$ = class_($2,$4,$6,stringtable.add_string(curr_filename)); }
|   error
                        {  }
;

feature_list_semicolon:
    feature ';'
                        { $$ = single_Features($1); }
|   feature_list_semicolon feature ';'
...
|   OBJECTID '(' formal_list_comma ')' ':' TYPEID '{' expression '}'
                        { $$ = method($1, $3, $6, $8); }
